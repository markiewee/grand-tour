...
3. Run `grandtour gaps trips/<id>/trip.json` and show the traveller every line it prints.
...
5. Inside 16 days of departure, run `grandtour weather trips/<id>/trip.json` and put the forecast on each day.
